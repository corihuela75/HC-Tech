...
export const isolateByCompany = (req, res, next) => {
  ...
  if (!empresa_id && req.user.rol !== 'superadmin') {
    // <-- Mantenemos la comprobación solo para este caso límite.
  ...
  // 5. Adjuntamos el ID de la empresa (será undefined para Super-Admin sin empresa_id)
  req.empresaId = empresa_id

  // 6. Inicializar body (por seguridad)
  if (!req.body) req.body = {}

  // 7. Inyectar empresa_id en req y req.body
